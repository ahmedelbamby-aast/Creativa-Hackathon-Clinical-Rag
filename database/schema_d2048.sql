-- Migration: 2048-dimension embedding parent table
--
-- Creates the parent table that holds 2048-d Gemini Embedding 2 vectors.
...
CREATE TABLE IF NOT EXISTS rag_chunks_d2048 (
...
CREATE INDEX IF NOT EXISTS rag_chunks_d2048_document_idx
    ON rag_chunks_d2048 (namespace, document_name);

CREATE INDEX IF NOT EXISTS rag_chunks_d2048_category_idx
    ON rag_chunks_d2048 (namespace, category);
