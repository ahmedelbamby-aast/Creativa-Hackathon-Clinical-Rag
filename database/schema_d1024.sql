-- Migration: 1024-dimension embedding parent table
--
-- Creates the parent table that holds 1024-d Gemini Embedding 2 vectors.
...
CREATE TABLE IF NOT EXISTS rag_chunks_d1024 (
...
CREATE INDEX IF NOT EXISTS rag_chunks_d1024_document_idx
    ON rag_chunks_d1024 (namespace, document_name);

CREATE INDEX IF NOT EXISTS rag_chunks_d1024_category_idx
    ON rag_chunks_d1024 (namespace, category);
